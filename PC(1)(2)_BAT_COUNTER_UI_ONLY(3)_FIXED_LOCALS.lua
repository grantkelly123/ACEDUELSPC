...
local aceGuiScaleValue = 0.90
local aceProgressBarScaleValue = 1.00
CONFIG_FILE = "AceDuels_PC_MainGUI_Config_DefaultsV2.json"
KEYBINDS_CONFIG_FILE = "AceDuels_PC_Keybinds_DefaultsV2.json"
...
aceGuiScaleValue = math.clamp(tonumber(aceGuiScaleValue) or 0.90, 0.50, 1.50)
...
section(Settings, "INTRO", 6)
do
local row, setVisual = toggleRow(Settings, "Intro", _introEnabled, 7)
...
pcall(function()
aceGuiScaleValue = 0.90
aceProgressBarScaleValue = 1.00
...
_G.AceApplyMobileButtonSize = function() end
_G.AceResetMobileButtons = function() end
end)
